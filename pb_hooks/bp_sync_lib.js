...
// ── Basketplan Sync helpers ──
// Extracted from bp_sync.pb.js for PB 0.36 JSVM scope isolation.
...
function extractLeagueHoldingIds(teamXml) {
  ...
  if (lhMatches) {
    ...
    var seasonPrefix = String(seasonStartYear)
...
module.exports = {
  BP_BASE: BP_BASE,
  BP_CLUB_ID: BP_CLUB_ID,
  HALL_MAP: HALL_MAP,
  STATUS_MAP: STATUS_MAP,
  getAttr: getAttr,
  fetchTeamXml: fetchTeamXml,
  parseGames: parseGames,
  extractLeagueHoldingIds: extractLeagueHoldingIds,
  fetchRankingXml: fetchRankingXml,
  parseRankings: parseRankings,
  buildTeamLookups: buildTeamLookups,
  syncGames: syncGames,
