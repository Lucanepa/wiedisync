...
// ── Scorer Reminders helpers ──
// Extracted from scorer_reminders.pb.js for PB 0.36 JSVM scope isolation.
...
module.exports = {
  ...
  buildIcsUrl: buildIcsUrl,
  buildIcsContent: buildIcsContent,
  badgeColorForRole: badgeColorForRole,
