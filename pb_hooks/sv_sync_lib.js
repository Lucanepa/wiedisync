...
// ── Swiss Volley Sync helpers ──
// Extracted from sv_sync.pb.js for PB 0.36 JSVM scope isolation.
...
module.exports = {
  SV_API_BASE: SV_API_BASE,
  SV_API_KEY: SV_API_KEY,
  SV_TEAM_IDS: SV_TEAM_IDS,
  isKscwTeamId: isKscwTeamId,
  deriveSeason: deriveSeason,
  parsePlayDate: parsePlayDate,
  mapSetResults: mapSetResults,
  determineStatus: determineStatus,
  buildTeamLookup: buildTeamLookup,
  buildHallLookup: buildHallLookup,
  mapReferees: mapReferees,
  buildCaptionLookups: buildCaptionLookups,
  syncGames: syncGames,
