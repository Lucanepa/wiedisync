export default function BasketballIcon({ className = 'h-5 w-5', filled = false }: { className?: string; filled?: boolean }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke={filled ? '#1a1a1a' : 'currentColor'} strokeWidth={filled ? 1.5 : 2} strokeLinecap="round" strokeLinejoin="round">
