 ...
 *
 * Usage:
 *   DIRECTUS_URL=https://directus-dev.kscw.ch ADMIN_EMAIL=admin@kscw.ch ADMIN_PASSWORD=Admin1234! node directus/scripts/setup-permissions.mjs
...
const ADMIN_PASSWORD = (process.env.ADMIN_PASSWORD || 'Admin1234!').replace(/\\!/g, '!')
